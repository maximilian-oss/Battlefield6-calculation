...
#
# Fixed model:
# - Update 1.3.3.0 automatic-primary recoil, damage, and ADS spread data
#   from Sym.gg (37 weapons)
...
BUILD_ID = "BF6-MC-262144-CLASS-QUICK-SELECT-R16"
MODEL_VERSION = "1.3.3 recoil/damage/ADS spread/hit zones/armor"
...
# Sym.gg Battlefield 6 data version 1.3.3.0 (30 JUN 2026).
# Values are the no-attachment standing recoil shown on the weapon chart:
# (recoil amount, mean direction, direction variation per side), in degrees.
RECOIL_DATA_133: dict[str, tuple[float, float, float]] = {
    "m433": (0.79, -22.0, 41.4),
    "b36a4": (0.73, -15.0, 28.0),
    "sor556mk2": (0.62, -9.0, 12.7),
    "ak4d": (0.85, -18.0, 20.0),
    "tr7": (1.16, 20.0, 40.8),
    "kord6p67": (0.54, 18.0, 28.9),
    "nvo228e": (0.73, -12.0, 28.9),
    "l85a3": (0.67, 12.0, 22.8),
    "vcr2": (0.82, 18.0, 50.3),
    "m16a4": (0.73, -21.0, 29.2),
    "m4a1": (0.85, -18.0, 30.7),
    "m277": (0.95, -22.0, 34.4),
    "ak205": (0.51, 6.0, 7.4),
    "m417a2": (0.94, -16.0, 15.4),
    "grtbc": (0.81, 16.0, 26.1),
    "qbz192": (0.77, -10.0, 19.9),
    "sg553r": (0.83, -20.0, 35.8),
    "sor300sc": (0.74, -12.0, 15.8),
    "sgx": (0.60, -18.0, 31.7),
    "pw5a3": (0.56, -10.0, 28.3),
    "pw7a2": (0.51, -10.0, 27.8),
    "umg40": (0.60, -16.0, 13.0),
    "usg90": (0.55, 10.0, 35.5),
    "kv9": (0.54, 22.0, 50.0),
    "scw10": (0.71, -18.0, 33.5),
    "sl9": (0.52, 0.0, 13.0),
    "cz3a1": (0.68, -15.0, 50.8),
    "l110": (0.57, 0.0, 31.0),
    "drsiar": (0.71, -14.0, 29.3),
    "m60": (0.74, 0.0, 29.9),
    "rpkm": (0.66, 5.0, 17.5),
    "m123k": (0.61, -10.0, 47.7),
    "m250": (0.73, -14.0, 35.9),
    "kts100mk8": (0.52, 8.0, 9.5),
    "m240l": (0.81, 5.0, 34.5),
    "m121a2": (0.81, -7.0, 31.8),
    "rpk74m": (0.48, 6.0, 16.1),
}

weapon_ids = {weapon["id"] for weapon in WEAPON_DATA}
if weapon_ids != set(RECOIL_DATA_133):
    missing = sorted(weapon_ids - set(RECOIL_DATA_133))
    extra = sorted(set(RECOIL_DATA_133) - weapon_ids)
    raise RuntimeError(f"1.3.3 recoil data mismatch: missing={missing}, extra={extra}")

for weapon in WEAPON_DATA:
    recoil_amount, recoil_mean, recoil_variation = RECOIL_DATA_133[weapon["id"]]
    weapon["recoil_amount_deg"] = recoil_amount
    weapon["recoil_mean_direction_deg"] = recoil_mean
    weapon["recoil_direction_variation_per_side_deg"] = recoil_variation
    weapon["source_model_version"] = "1.3.3.0"

# Sym.gg Battlefield 6 data version 1.3.3.0 (30 JUN 2026).
# Each entry contains:
# damage segments, ADS min/max spread, spread increase per shot,
# first-shot multiplier, firing recovery coefficient/exponent/offset,
# not-firing recovery coefficient/exponent/offset, radial distribution exponent.
WEAPON_DAMAGE_SPREAD_DATA_133: dict[str, tuple[Any, ...]] = {
    "m433": ([(0.0, 21.0, 26.05), (21.0, 75.0, 20.67), (75.0, None, 17.13)], 0.05, 7.0, 0.36, 1.0, 1.2, 2.5, 2.7, 0.0, 0.25, 7.2, 0.5),
    "b36a4": ([(0.0, 21.0, 26.05), (21.0, 75.0, 20.67), (75.0, None, 17.13)], 0.05, 7.0, 0.36, 1.0, 1.2, 2.5, 2.7, 0.0, 0.25, 7.2, 0.5),
    "sor556mk2": ([(0.0, 21.0, 26.05), (21.0, 75.0, 20.67), (75.0, None, 17.13)], 0.05, 7.0, 0.36, 1.0, 1.2, 2.5, 2.7, 0.0, 0.25, 7.2, 0.5),
    "ak4d": ([(0.0, 21.0, 35.22), (21.0, 75.0, 26.05), (75.0, None, 20.67)], 0.05, 7.0, 0.523, 1.0, 1.2, 2.5, 2.7, 0.0, 0.25, 7.2, 0.5),
    "tr7": ([(0.0, 21.0, 35.22), (21.0, 75.0, 26.05), (75.0, None, 20.67)], 0.05, 7.0, 0.523, 1.0, 1.2, 2.5, 2.7, 0.0, 0.25, 7.2, 0.5),
    "kord6p67": ([(0.0, 21.0, 20.67), (21.0, 75.0, 17.13), (75.0, None, 14.62)], 0.05, 7.0, 0.28, 1.0, 1.2, 2.5, 2.7, 0.0, 0.25, 7.2, 0.5),
    "nvo228e": ([(0.0, 9.0, 35.22), (9.0, 21.0, 27.48), (21.0, 36.0, 21.56), (36.0, 75.0, 20.67), (75.0, None, 17.13)], 0.05, 7.0, 0.409, 1.0, 1.2, 2.5, 2.7, 0.0, 0.25, 7.2, 0.5),
    "l85a3": ([(0.0, 21.0, 26.05), (21.0, 75.0, 20.67), (75.0, None, 17.13)], 0.05, 7.0, 0.36, 1.0, 1.2, 2.5, 2.7, 0.0, 0.25, 7.2, 0.5),
    "vcr2": ([(0.0, 21.0, 26.05), (21.0, 75.0, 20.67), (75.0, None, 17.13)], 0.05, 7.0, 0.36, 1.0, 1.2, 2.5, 2.7, 0.0, 0.25, 7.2, 0.5),
    "m16a4": ([(0.0, 21.0, 26.05), (21.0, 75.0, 20.67), (75.0, None, 17.13)], 0.05, 7.0, 0.36, 1.0, 1.2, 2.5, 2.7, 0.0, 0.25, 7.2, 0.5),
    "m4a1": ([(0.0, 9.0, 26.05), (9.0, 21.0, 21.56), (21.0, 36.0, 17.74), (36.0, 75.0, 17.13), (75.0, None, 14.62)], 0.05, 6.0, 0.304, 1.0, 1.2, 2.5, 2.7, 0.0, 0.25, 7.2, 0.5),
    "m277": ([(0.0, 75.0, 26.05), (75.0, None, 20.67)], 0.05, 6.0, 0.409, 1.0, 1.2, 2.5, 2.7, 0.0, 0.25, 7.2, 0.5),
    "ak205": ([(0.0, 9.0, 20.67), (9.0, 21.0, 17.74), (21.0, 36.0, 15.07), (36.0, 75.0, 14.62), (75.0, None, 12.76)], 0.05, 6.0, 0.239, 1.0, 1.2, 2.5, 2.7, 0.0, 0.25, 7.2, 0.5),
    "m417a2": ([(0.0, 9.0, 35.22), (9.0, 21.0, 27.48), (21.0, 36.0, 21.56), (36.0, 75.0, 20.67), (75.0, None, 17.13)], 0.05, 6.0, 0.409, 1.0, 1.2, 2.5, 2.7, 0.0, 0.25, 7.2, 0.5),
    "grtbc": ([(0.0, 9.0, 26.05), (9.0, 21.0, 21.56), (21.0, 36.0, 17.74), (36.0, 75.0, 17.13), (75.0, None, 14.62)], 0.05, 6.0, 0.304, 1.0, 1.2, 2.5, 2.7, 0.0, 0.25, 7.2, 0.5),
    "qbz192": ([(0.0, 9.0, 26.05), (9.0, 21.0, 21.56), (21.0, 36.0, 17.74), (36.0, 75.0, 17.13), (75.0, None, 14.62)], 0.05, 6.0, 0.304, 1.0, 1.2, 2.5, 2.7, 0.0, 0.25, 7.2, 0.5),
    "sg553r": ([(0.0, 9.0, 35.22), (9.0, 21.0, 26.05), (21.0, 36.0, 20.67), (36.0, 75.0, 17.13), (75.0, None, 14.62)], 0.05, 6.0, 0.36, 1.0, 1.2, 2.5, 2.7, 0.0, 0.25, 7.2, 0.5),
    "sor300sc": ([(0.0, 9.0, 35.22), (9.0, 21.0, 26.05), (21.0, 36.0, 20.67), (36.0, 75.0, 17.13), (75.0, None, 14.62)], 0.05, 6.0, 0.36, 1.0, 1.2, 2.5, 2.7, 0.0, 0.25, 7.2, 0.5),
    "sgx": ([(0.0, 9.0, 26.05), (9.0, 21.0, 20.67), (21.0, 36.0, 17.13), (36.0, 75.0, 14.62), (75.0, None, 12.76)], 0.05, 6.0, 0.28, 1.0, 1.2, 2.5, 2.7, 0.0, 0.25, 7.2, 0.5),
    "pw5a3": ([(0.0, 9.0, 26.05), (9.0, 21.0, 20.67), (21.0, 36.0, 17.13), (36.0, 75.0, 14.62), (75.0, None, 12.76)], 0.05, 6.0, 0.28, 1.0, 1.2, 2.5, 2.7, 0.0, 0.25, 7.2, 0.5),
    "pw7a2": ([(0.0, 21.0, 17.13), (21.0, 75.0, 14.62), (75.0, None, 12.76)], 0.05, 6.0, 0.221, 1.0, 1.2, 2.5, 2.7, 0.0, 0.25, 7.2, 0.5),
    "umg40": ([(0.0, 9.0, 26.05), (9.0, 21.0, 21.56), (21.0, 36.0, 17.74), (36.0, 75.0, 17.13), (75.0, None, 14.62)], 0.05, 6.0, 0.304, 1.0, 1.2, 2.5, 2.7, 0.0, 0.25, 7.2, 0.5),
    "usg90": ([(0.0, 9.0, 20.67), (9.0, 21.0, 17.74), (21.0, 36.0, 15.07), (36.0, 75.0, 14.62), (75.0, None, 12.76)], 0.05, 6.0, 0.239, 1.0, 1.2, 2.5, 2.7, 0.0, 0.25, 7.2, 0.5),
    "kv9": ([(0.0, 9.0, 26.05), (9.0, 21.0, 20.67), (21.0, 36.0, 17.13), (36.0, 75.0, 14.62), (75.0, None, 12.76)], 0.05, 6.0, 0.28, 1.0, 1.2, 2.5, 2.7, 0.0, 0.25, 7.2, 0.5),
    "scw10": ([(0.0, 9.0, 35.22), (9.0, 21.0, 26.05), (21.0, 36.0, 20.67), (36.0, 75.0, 17.13), (75.0, None, 14.62)], 0.05, 6.0, 0.36, 1.0, 1.2, 2.5, 2.7, 0.0, 0.25, 7.2, 0.5),
    "sl9": ([(0.0, 9.0, 26.05), (9.0, 21.0, 20.67), (21.0, 36.0, 17.13), (36.0, 75.0, 14.62), (75.0, None, 12.76)], 0.05, 6.0, 0.28, 1.0, 1.2, 2.5, 2.7, 0.0, 0.25, 7.2, 0.5),
    "cz3a1": ([(0.0, 9.0, 26.05), (9.0, 21.0, 20.67), (21.0, 36.0, 17.13), (36.0, 75.0, 14.62), (75.0, None, 12.76)], 0.05, 6.0, 0.28, 1.0, 1.2, 2.5, 2.7, 0.0, 0.25, 7.2, 0.5),
    "l110": ([(0.0, 21.0, 26.05), (21.0, 75.0, 20.67), (75.0, None, 17.13)], 0.05, 11.0, 0.36, 1.0, 1.2, 2.5, 2.7, 0.0, 0.25, 7.2, 0.5),
    "drsiar": ([(0.0, 21.0, 26.05), (21.0, 75.0, 20.67), (75.0, None, 17.13)], 0.05, 9.0, 0.36, 1.0, 1.2, 2.5, 2.7, 0.0, 0.25, 7.2, 0.5),
    "m60": ([(0.0, 21.0, 35.22), (21.0, 75.0, 26.05), (75.0, None, 20.67)], 0.05, 11.0, 0.523, 1.0, 1.2, 2.5, 2.7, 0.0, 0.25, 7.2, 0.5),
    "rpkm": ([(0.0, 9.0, 35.22), (9.0, 21.0, 27.48), (21.0, 36.0, 21.56), (36.0, 75.0, 20.67), (75.0, None, 17.13)], 0.05, 9.0, 0.409, 1.0, 1.2, 2.5, 2.7, 0.0, 0.25, 7.2, 0.5),
    "m123k": ([(0.0, 21.0, 26.05), (21.0, 75.0, 20.67), (75.0, None, 17.13)], 0.05, 11.0, 0.36, 1.0, 1.2, 2.5, 2.7, 0.0, 0.25, 7.2, 0.5),
    "m250": ([(0.0, 15.0, 26.05), (15.0, None, 26.05)], 0.05, 11.0, 0.409, 1.0, 1.2, 2.5, 2.7, 0.0, 0.25, 7.2, 0.5),
    "kts100mk8": ([(0.0, 21.0, 26.05), (21.0, 75.0, 20.67), (75.0, None, 17.13)], 0.05, 9.0, 0.36, 1.0, 1.2, 2.5, 2.7, 0.0, 0.25, 7.2, 0.5),
    "m240l": ([(0.0, 21.0, 35.22), (21.0, 75.0, 26.05), (75.0, None, 20.67)], 0.05, 11.0, 0.523, 1.0, 1.2, 2.5, 2.7, 0.0, 0.25, 7.2, 0.5),
    "m121a2": ([(0.0, 21.0, 35.22), (21.0, 75.0, 26.05), (75.0, None, 20.67)], 0.05, 11.0, 0.523, 1.0, 1.2, 2.5, 2.7, 0.0, 0.25, 7.2, 0.5),
    "rpk74m": ([(0.0, 21.0, 20.67), (21.0, 75.0, 17.13), (75.0, None, 14.62)], 0.05, 9.0, 0.28, 1.0, 1.2, 2.5, 2.7, 0.0, 0.25, 7.2, 0.5),
}

if weapon_ids != set(WEAPON_DAMAGE_SPREAD_DATA_133):
    missing = sorted(weapon_ids - set(WEAPON_DAMAGE_SPREAD_DATA_133))
    extra = sorted(set(WEAPON_DAMAGE_SPREAD_DATA_133) - weapon_ids)
    raise RuntimeError(
        f"1.3.3 damage/spread data mismatch: missing={missing}, extra={extra}"
    )
...
for weapon in WEAPON_DATA:
    (
        ...
        not_firing_offset,
        radial_exp,
    ) = WEAPON_DAMAGE_SPREAD_DATA_133[weapon["id"]]
    weapon["damage_profile"] = [
        {"min_range": start, "max_range": end, "damage": damage}
        for start, end, damage in damage_segments
    ]
    weapon["ads_stand_min_deg"] = ads_min
    weapon["ads_stand_max_deg"] = ads_max
    weapon["spread_increase_per_shot_deg"] = spread_inc
    weapon["spread_first_shot_multiplier"] = first_shot_mul
    weapon["spread_firing_decrease_coefficient"] = firing_coef
    weapon["spread_firing_decrease_exponent"] = firing_exp
    weapon["spread_firing_decrease_offset"] = firing_offset
    weapon["spread_not_firing_decrease_coefficient"] = not_firing_coef
    weapon["spread_not_firing_decrease_exponent"] = not_firing_exp
    weapon["spread_not_firing_decrease_offset"] = not_firing_offset
    weapon["spread_radial_distribution_exponent"] = radial_exp
